...
add wave -noupdate -expand -group {filter IO} -color {Cornflower Blue} -radix unsigned /dual_router_tb/f02_in_cnt
add wave -noupdate -expand -group {filter IO} -color orange /dual_router_tb/f02_resetting
add wave -noupdate -expand -group {filter IO} -color cyan /dual_router_tb/f02_pkt_valid
add wave -noupdate -expand -group {filter IO} -color tan /dual_router_tb/f02_pkt_discard_x
add wave -noupdate -expand -group {filter IO} -color tan /dual_router_tb/f02_pkt_discard_y
add wave -noupdate -expand -group {filter IO} -color cyan /dual_router_tb/f02_in0_empty
add wave -noupdate -expand -group {filter IO} /dual_router_tb/f02_in0_next
add wave -noupdate -expand -group {filter IO} /dual_router_tb/f02_in0_isk
add wave -noupdate -expand -group {filter IO} /dual_router_tb/f02_in0_data
add wave -noupdate -expand -group {filter IO} -color cyan /dual_router_tb/f02_in1_empty
add wave -noupdate -expand -group {filter IO} /dual_router_tb/f02_in1_next
add wave -noupdate -expand -group {filter IO} /dual_router_tb/f02_in1_isk
add wave -noupdate -expand -group {filter IO} /dual_router_tb/f02_in1_data
...
add wave -noupdate -group xrouter -color tan /dual_router_tb/xr_in_valid
add wave -noupdate -group xrouter -color tan /dual_router_tb/xr_in_next
add wave -noupdate -group xrouter -color tan /dual_router_tb/xr_in_isk
add wave -noupdate -group xrouter -color tan /dual_router_tb/xr_in_data
...
add wave -noupdate -group yrouter /dual_router_tb/yr_in_valid
add wave -noupdate -group yrouter /dual_router_tb/yr_in_isk
add wave -noupdate -group yrouter /dual_router_tb/yr_in_data
...
add wave -noupdate -group TX0 /dual_router_tb/f02_out0_write
...
add wave -noupdate -group TX1 /dual_router_tb/f02_out1_write
...
add wave -noupdate -expand -group RX0 /dual_router_tb/ping0_fifo_next
...
add wave -noupdate -expand -group RX1 /dual_router_tb/ping1_fifo_next
...
WaveRestoreCursors {{Cursor 1} {223125000 ps} 0} {{Cursor 2} {33632813 ps} 0}
